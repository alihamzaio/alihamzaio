...
<img src="./assets/dev-terminal.svg" alt="Ali Hamza Full Stack Developer animated terminal" width="860" />
...
I'm a **Full Stack Developer** based in **Lahore, Pakistan**. I build and ship real products, from the React/Next.js UI through the Node.js API, database, and AWS deploy.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,nextjs,ts,nodejs,express,mongodb,postgres,redis,aws,docker,terraform,graphql,tailwind,redux" alt="React Next.js TypeScript Node Express MongoDB PostgreSQL Redis AWS Docker Terraform GraphQL Tailwind Redux" />
</p>
...
- Write APIs and UI other developers can extend without digging through history
...
Hiring a Full Stack Developer (MERN / Next.js / AWS / Web3), or need help shipping a product? Reach out at [hamzasarwer9@gmail.com](mailto:hamzasarwer9@gmail.com).
